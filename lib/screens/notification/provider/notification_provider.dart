  ...
  sendNotification() async {
    try {
      ...
      if (response.isOk) {
        ...
        SnackBarHelper.showErrorSnackBar(' failed to send notification :${response.statusText}');
        }
    } catch (e) {
      print(e);
      SnackBarHelper.showErrorSnackBar(' Error sending notification :$e');
      rethrow;
    ...
    try{
      ...
      if (response.isOk) {
        ...
        if (apiResponse.success == true) {
          ...
          SnackBarHelper.showErrorSnackBar(' failed to delete notification :${response.body?['message'] ?? response.statusText}');
        }
      } catch (e) {
        print(e);
        rethrow;
    ...
    try {
      ...
      if (response.isOk) {
        ...
        if (apiResponse.success == true) {
          ...
          print(myNotificationResult?.platform);
          notifyListeners();
          return null;
        } else {
          SnackBarHelper.showErrorSnackBar(' failed to get notification info :${apiResponse.message}');
